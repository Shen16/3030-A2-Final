...
import newtemp.NewTempSensor.Subject; //new
import newtemp.NewTempSensor.NewTempSensorDriver; //new
...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        */
        ...
        OurFurnace n = new PlainGasF1();  //OurFurnace==Car,,   PlainGasF1 is one of the Concrete chain end--> Cangura
        n = new Humidifier(n);  //Humidifie  is a feature/component
        n = new WiFi(n);  //Wifi  is a feature/component
        n.turnOn();  //is the cost() method
